...
_MAINMESSAGE = _descriptor.Descriptor(
  ...
  nested_types=[_MAINMESSAGE_INTTOLSTINTSMAPENTRY, _MAINMESSAGE_STRTOMESSAGEMAPENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
